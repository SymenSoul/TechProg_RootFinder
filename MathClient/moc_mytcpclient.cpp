...
void MyTcpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MyTcpClient::*)()>(_a, &MyTcpClient::connected, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (MyTcpClient::*)()>(_a, &MyTcpClient::disconnected, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (MyTcpClient::*)(QString )>(_a, &MyTcpClient::messageReceived, 2))
            return;
    }
}
...
// SIGNAL 2
void MyTcpClient::messageReceived(QString _t1)
{
